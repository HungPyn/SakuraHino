            ...
            <View style={styles.achievementGrid}>
              {[
                ...
                <View key={index} style={styles.achievementItem}>
                  <View style={[styles.achievementIcon, item.disabled && styles.disabledIcon]}>
                    <Icon name={item.icon} size={24} color={item.disabled ? '#666' : '#FFC1CC'} />
                  </View>
                  <Text style={styles.subText}>{item.label}</Text>
                </View>
              ))}
...
const styles = StyleSheet.create({
  ...
  profileHeader: { flexDirection: 'row', backgroundColor: '#fff', borderRadius: 8, padding: 10, elevation: 2 },
  avatar: { width: 80, height: 80, borderRadius: 40, backgroundColor: '#FFC1CC', justifyContent: 'center', alignItems: 'center' },
  ...
  statCard: { alignItems: 'center', backgroundColor: '#fff', borderRadius: 8, padding: 10, elevation: 2, width: '30%' },
  statValue: { fontSize: 20, fontWeight: '500' },
  achievementCard: { backgroundColor: '#fff', borderRadius: 8, padding: 10, elevation: 2 },
  achievementHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 10 },
  achievementIconContainer: { width: 32, height: 32, borderRadius: 16, backgroundColor: '#ffe0e6', justifyContent: 'center', alignItems: 'center', marginRight: 10 },
  ...
  settingItem: { flexDirection: 'row', alignItems: 'center', padding: 10, backgroundColor: '#fff', borderRadius: 8, elevation: 2, marginBottom: 5 },
  settingIcon: { width: 32, height: 32, borderRadius: 16, backgroundColor: '#ffe0e6', justifyContent: 'center', alignItems: 'center', marginRight: 10 },
