  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: "reminders",
        name: "Reminders",
        component: () => import("@/components/admin/ReminderView.vue"),
      },
      {
        path: "entertainment",
        name: "Entertainment",
      ...
      {
        path: "vocabulary-difficult",
        name: "VocabularyDifficult",
        component: () =>
          import("@/components/entertainment/VocabularyDifficultTab.vue"),
      },
    ],
  },
];
