      ...
      <div class="advanced-filter-modal-content">
        ...
        <div class="modal-body">
          <div class="filter-group-modal">
            <label class="filter-label"><i class="bi bi-tags-fill icon"></i> Chủ đề:</label>
            <select v-model="filters.topicId" class="form-select">
              <option :value="null">Tất cả</option>
              <option v-for="t in topics" :key="t.id" :value="t.id">{{ t.name }}</option>
            </select>
          </div>
          <div class="filter-group-modal">
            <label class="filter-label"><i class="bi bi-clock-fill icon"></i> Trạng thái:</label>
...
export default {
  ...
  methods: {
    ...
    resetFilters() {
      this.filters = { topicId: null, status: '' };
      this.searchQuery = '';
      this.applyFilters();
    },
  },
