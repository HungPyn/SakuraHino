...
export const storyData = [
  ...
  },
  {
    ...
    description: 'Những cuộc phiêu lưu đầu tiên của Nobita và mèo máy Doraemon.',
    genre: 'comic',
    status: 'published',
    chapter: 1,
  ...
  },
  {
    ...
    content: 'Sakura, một ninja tập sự, đang trên đường thực hiện nhiệm vụ đầu tiên...'
  },
  {
    id: 6,
    ...
    content: '1. Saru mo ki kara ochiru (Ngay cả khỉ cũng có lúc ngã từ trên cây).'
  },
  {
    id: 7,
