...
let topics = [
    {
        ...
        description: 'Các bài học về chào hỏi, giới thiệu bản thân, và các mẫu câu giao tiếp hàng ngày.',
        url_image: 'https://cdn-icons-png.flaticon.com/512/2936/2936746.png', // Icon ví dụ
    ...
    },
    {
        id: 2,
        name: 'Ngữ pháp N5',
        description: 'Tổng hợp các cấu trúc ngữ pháp cơ bản cho kỳ thi JLPT N5, bao gồm trợ từ, thể động từ, tính từ, v.v.',
        url_image: 'https://cdn-icons-png.flaticon.com/512/3067/3067406.png',
        status: 'active',
    ...
    },
    {
        id: 3,
        name: 'Từ vựng N4',
        description: 'Cung cấp và giải thích các từ vựng thiết yếu cho cấp độ JLPT N4, xoay quanh các chủ đề quen thuộc.',
        url_image: 'https://cdn-icons-png.flaticon.com/512/2996/2996078.png',
        status: 'active',
    ...
    },
    {
        ...
        description: 'Giới thiệu các Hán tự thường gặp ở cấp độ JLPT N3, với các ví dụ và cách đọc.',
        url_image: 'https://cdn-icons-png.flaticon.com/512/820/820358.png',
        status: 'active',
    ...
    },
    {
        id: 5,
        name: 'Luyện nghe N2',
        description: 'Các bài luyện nghe nâng cao cho JLPT N2, tập trung vào hội thoại hàng ngày, tin tức và bài giảng ngắn.',
        url_image: 'https://cdn-icons-png.flaticon.com/512/2927/2927515.png',
        status: 'active',
    ...
    },
    {
        id: 6,
        name: 'Chủ đề Nhà cửa',
        description: 'Học từ vựng và các mẫu câu liên quan đến các phòng, đồ dùng, và hoạt động trong nhà.',
        url_image: 'https://cdn-icons-png.flaticon.com/512/5537/5537237.png',
        status: 'active',
...
const topicService = {
    ...
    validateTopicData: (topicData) => {
        ...
        if (!topicData.name || typeof topicData.name !== 'string' || topicData.name.trim() === '') {
        ...
        if (topicData.url_image && typeof topicData.url_image === 'string' && topicData.url_image.trim() !== '') {
            try {
        ...
        if (!topicData.status || !validStatuses.includes(statusValue)) {
            errors.push(`Trạng thái "${topicData.status}" không hợp lệ. Phải là 'active' hoặc 'inactive'.`);
        }
        ...
        return new Promise(async (resolve) => {
            ...
            for (let i = 0; i < topicsToImport.length; i++) {
                ...
                if (validationResult.isValid) {
                    try {
                        const existingTopic = cleanedData.id ? topics.find(t => t.id === parseInt(cleanedData.id)) : null;
